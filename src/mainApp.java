            ...
            for (; ; ) {
                ...
                switch (choice) {
                    ...
                    case 2: {
                        ...
                        System.out.println("Select a nnumber from 1 to 3.");
                    ...
                    case 3: {
                        ...
                        Evaluatee selectedAssessee = null;
                        selectedAssessee = EvaluateesList.getAssessee(selectedAssesseeCode);
                        ...
                        if (selectedQuestion.type == 1) {
                            ...
                            Lista_Apanthsewn.add(new Answer(selectedAssessee, selectedQuestion, answers));
                        }
                            ...
                            Lista_Apanthsewn.add(new Answer(selectedAssessee, selectedQuestion, answer));
                        }
                        else {
                    ...
                    case 5: {
                        ...
                        //Epilogh Ajiologoumenou
                        System.out.println();
                        System.out.print("Select Evaluatee (code): ");
                        int Code_Ajiologoumenou = in.nextInt();
                        in.nextLine(); // bug me to \n


                        Evaluatee SelectedEvaluatee = null;
                        SelectedEvaluatee = EvaluateesList.getAssessee(Code_Ajiologoumenou);
